<%@ Page Title="" Language="C#" MasterPageFile="~/index/Site.master" AutoEventWireup="true" CodeFile="SürücüDüzenle.aspx.cs" Inherits="index_Default3" %>
    ...
    <p>
        ...
        <tr>
            <td class="style2">
                &nbsp;</td>
            <td>
                <asp:Button ID="btnSürücüDuzenle" runat="server" onclick="btnSürücüDuzenle_Click" 
                    Text="Düzenle" />
            </td>
        </tr>
    </table></p>
